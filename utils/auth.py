...
Handles admin login, session management, access control, and registration control
"""
...
def is_registration_locked() -> bool:
    """
    Check if registration is currently locked by admin
    
    Returns:
        True if registration is locked, False if open
    """
    ...
    if settings_file.exists():
        try:
            ...
            return settings.get('registration_locked', False)
        except:
            return False
