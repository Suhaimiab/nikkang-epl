...
def main():
    ...
    with col2:
        st.markdown("""
        **⚡ Scoring System:**
        - **6 points** for exact score prediction
        - **3 points** for correct result (win/draw/loss)
        - **GOTW doubles** your points for that match
        - **Week 38 doubles** all your points
        - **KK Champions** - Most exact scores wins special recognition!
        """)
